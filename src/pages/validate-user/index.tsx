        ...
        <Layout>
            <main className="px-5">
                <StepperFrame className='h-[484px] w-[308px] mx-auto mt-[84px]'>
                    ...
                    <p className="mt-[20px] leading-9 font-normal text-center text-[24px]">&#8358;<span className="font-[900]">2,000</span>.00</p>
                    <p className="mt-[30px] leading-8 font-[600] text-center text-[17px]">Please Wait.</p>
                    <p className="mt-[14px] leading-5 font-normal text-center text-[13px] text-[#006E72]">Validating user credentials....</p>
