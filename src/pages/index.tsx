        ...
        <StepperFrame>
          ...
          <div className="px-[25px] mt-8">
            <div className="flex justify-between items-center">
              ...
              <VLink href="/">
                <span className="text-sm text-[#006E72] font-[600] flex items-center">Skip <FaChevronRight /></span>
              </VLink>
            </div>
          </div>
          ...
          <div className="overflow-hidden mt-[50px] px-[25px]">
            <div className="w-full no-scrollbar flex gap-[15px] snap-x scroll-pl-[25px] overflow-x-auto">
              {attachments.map(link => <AttachmentCard image={link} key={link} cardClassName="border-2 border-[#82ECD3]" />)}
            </div>
          </div>
